...
public class YDataLogger : YFunction
{
  ...
  public const int TIMEUTC_INVALID = YAPI.INVALID_UNSIGNED;
  ...
  protected int _oldestRunIndex;
  protected int _currentRunIndex;
  protected int _samplingInterval;
  protected int _timeUTC;
   ...
   * </para>
   */
  public int set_timeUTC(int newval)
  {
    string rest_val;
    rest_val = (newval).ToString();
